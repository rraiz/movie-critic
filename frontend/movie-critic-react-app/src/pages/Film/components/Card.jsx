...
export default function Card({ member }) {
  return (
    <div className="w-[150px] min-h-[200px] max-h-[300px] rounded-lg card-shadow bg-[#2828295e] flex flex-col flex-none">
      ...
      <div className="px-[10px] py-[10px] text-center flex-grow">
        ...
        <p className="text-gray-400 text-sm whitespace-normal card-line-clamp">{member.character}</p>
      </div>
    </div>
  );
}
